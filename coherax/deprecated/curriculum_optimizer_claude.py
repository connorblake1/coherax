...
Usage:
    python -m coherax.curriculum_optimizer_claude
    python -m coherax.curriculum_optimizer_claude --gamma_target 0.10 --N_depth 6
"""
...
from coherax.multi_round_claude import simulate_rounds
