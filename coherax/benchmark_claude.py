...
Usage:
    python -m coherax.benchmark_claude              # default settings
    python -m coherax.benchmark_claude --quick       # fast test run
    python -m coherax.benchmark_claude --full        # full benchmark
"""
...
from coherax.recovery_optimizer_claude import (
    optimize_recovery,
    validate_in_fock,
)
