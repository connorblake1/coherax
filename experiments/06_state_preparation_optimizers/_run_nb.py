"""Execute the self-contained Experiment 06 notebook."""
...
NOTEBOOK = "state_preparation_optimizers.ipynb"
notebook = nbformat.read(NOTEBOOK, as_version=4)
client = NotebookClient(notebook, timeout=21600, kernel_name="coherax")
